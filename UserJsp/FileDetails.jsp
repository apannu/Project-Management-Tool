...
<head>
<title>Cisco Project Management Portal - File Details</title>
...
<div class="main">
  ...
  <div class="content">
	...
	<legend class="text7">Document Details:</legend>
			<br/>
			<form action="UserServlet?action=GetFileDetails&userType=nonAdmin" method="post" name="fileDetailsForm">	
				<table>
					<tr>
					...
					<tr>
						<td><label class="text11">File Group:</label>
						<td><input type="text" name="fileGroup"></td>
					</tr>
				</table>
					<br/>
					<input type="submit" value="Select File" class="button fright" onclick="return uploadDocumentValidations();">${fileUploadMessage}
			</form>
			</fieldset>
        </div>
      </div>
