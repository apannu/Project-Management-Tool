					...
					<div class="article">
						<fieldset>
							...
							<form name="userForm" method="post" id="searchform"
								action="./UserServlet?action=ViewUserServlet&userType=nonAdmin">
								<input type="hidden" name="managerName" value="${username}">
								...
								<c:if test="${currentPage != 1}">
									...
									<td><a href="./UserServlet?action=ViewUserJsp&userType=nonAdmin&page=${currentPage - 1}">Previous</a>
									</td>
								</c:if>
									...
									<tr>
										<c:forEach begin="1" end="${noOfPages}" var="i">
											<c:choose>
												...
												<c:otherwise>
													<td><a href="./UserServlet?action=ViewUserJsp&userType=nonAdmin&page=${i}">${i}</a>
													</td>
												</c:otherwise>
											</c:choose>
										</c:forEach>
								...
								<c:if test="${currentPage lt noOfPages}">
									<td><a href="./UserServlet?action=ViewUserJsp&userType=nonAdmin&page=${currentPage + 1}">Next</a>
									</td>
								</c:if>
								</tr>
								
</table>
								<br /> <input type="submit" value="View Details" onClick="viewUserDetails();">
							</form>
						</fieldset>
					</div>
				</div>
