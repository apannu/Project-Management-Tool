...
<head>
<title>Cisco Project Management Portal - Upload Images</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <fieldset>
	<legend class="text7">Upload Images</legend>
			<br/>
			<form action="./UserServlet?action=ImageUploadServlet&userType=nonAdmin" method="post" name="fileUploadForm" enctype="multipart/form-data">	
				<table>
					<tr>
					...
					<br/>
					<input type="submit" value="Upload" class="button fright">
			</form>
			</fieldset>
        </div>
      </div>
