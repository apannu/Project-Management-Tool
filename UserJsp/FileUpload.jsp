...
<div class="main">
  ...
  <div class="content">
	...
	<legend class="text7">Upload Documents</legend>
			<br/>
			<form action="./UserServlet?action=FileUploadServlet&userType=nonAdmin" method="post" name="fileUploadForm" enctype="multipart/form-data">	
				<table>
					<tr>
						<td><label class="text11">File:</label>
						<td><input type="file" name="file" id="filename"></td>
						<td><c:out value="${param.fileName}"></c:out></td>
						<td></td>
					</tr>
				</table>
					<br/>
