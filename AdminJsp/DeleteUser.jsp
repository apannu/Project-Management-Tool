...
<head>
<title>Cisco Project Management Portal - Delete Users</title>
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<div class="article">
						<fieldset>
							<legend class="text7">Delete User</legend>
							<br />
							<br />
								<form name="userForm" method="post" id="searchform" action="./UserServlet?action=DeleteUserSearch&userType=admin">
									<div class="top-search">
										<div>
											...
											<input type="text" value="Enter the username" name="usernameField" id="s" onfocus="emptyUsernameTextbox()"/>&nbsp;&nbsp;&nbsp;<input type="submit" value="Search User" onclick="return viewUserValidations();">
										</div>
										<div>
											&nbsp&nbsp&nbsp&nbsp&nbsp<a href="./UserServlet?action=ViewInactiveUsersJsp">Display Unactive Users</a>
										</div>
									</div>
								<br />
								<p align="center"> ${deleteUserMessage} ${loggedErrorMessage1} 
								${billableMessage} </p>
								...
								<c:if test="${currentPage!= 1 && currentPage!=null}">
									...
									<td><a href="./UserServlet?action=DeleteUserJsp&page=${currentPage - 1}">Previous</a>
									</td>
								</c:if>
									...
									<tr>
										<c:forEach begin="1" end="${noOfPages}" var="i">
											<c:choose>
												...
												<c:otherwise>
													<td><a href="./UserServlet?action=DeleteUserJsp&page=${i}">${i}</a>
													</td>
												</c:otherwise>
											</c:choose>
										</c:forEach>
								...
								<c:if test="${currentPage lt noOfPages}">
									<td><a href="./UserServlet?action=DeleteUserJsp&page=${currentPage + 1}">Next</a>
									</td>
								</c:if>
								</tr>
